        ...
        <form className="p-5 lg:p-20 flex-col-10">
          ...
          <div className="flex-col-3">
            <div className="grid-2 gap-5">
              ...
              <div className="input-container">
                <input required onChange={handleChange} name={data.lastName} />
          ...
          <div className="flex-col-3">
            ...
            {contactFormD.map((data, index) => (
              <div
                ...
                key={index}
                className={`flex-3 ${contactId !== index ? 'border' : 'border-2 border-black dark:border-white'} bg-white dark:bg-[#0A0A0A] border-neutral-300 dark:border-neutral-800 p-3 rounded-lg relative`}
              >
              ...
              {contactId === index && <CheckCheck className="absolute right-5 transition-all"/>}
              </div>
            ))}
          </div>
