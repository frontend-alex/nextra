    ...
    <DashboardLayout>
        <div className="flex-col-10">
            ...
            <div className="flex-col-5">
                ...
                <div className="grid-3 gap-5">
                    <div className="flex-2"><h1>Draft</h1><div className="bg-neutral-300 dark:bg-neutral-800 p-[2px] px-[7px] rounded-sm">2</div></div>
                    <div className="flex-2"><h1>In Progress</h1><div className="bg-neutral-300 dark:bg-neutral-800 p-[2px] px-[7px] rounded-sm">3</div></div>
                    <div className="flex-2"><h1>Archived</h1><div className="bg-neutral-300 dark:bg-neutral-800 p-[2px] px-[7px] rounded-sm">0</div></div>
                </div>
                ...
                <div className="grid-3 gap-5">
                    {[1,2,3,4,5,6,7,8,9].map((_, index) => (
                        <div key={index} className="h-[200px] bg-neutral-300 dark:bg-neutral-900 rounded-md">
                        </div>
                    ))}
                </div>
            </div>
