      ...
      <div className="flex-col-10">
        <div className="flex-col-5">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5 lg:gap-0">
            ...
            <div className="r-flex-3">
              <DatePickerButton />
              <Button
                className="flex-2 text-stone-400 w-full lg:w-max"
                variant="outline"
              >
                <Filter size={15} />
                {t("filters")}
        ...
        <div className="flex-col-5">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-5 lg:gap-0">
            ...
            <Link href="#" className="underline text-sm text-stone-400">
              View All
            </Link>
          </div>
          <div className="grid-3 gap-5">
            <div className="flex-2">
              <h1>{t("draft")}</h1>
              <div className="bg-neutral-100 dark:bg-neutral-800 p-[2px] px-[7px] rounded-sm">
                2
              </div>
            </div>
            <div className="flex-2">
